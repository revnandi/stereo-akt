    ...
    <?php if ($year_groups): ?>
      ...
      <?php foreach ($year_groups as $key => $group_items): ?>
        ...
        <section class="c-archive__section">
          <h1 class="c-archive__section-title">
            <?php echo $key ?>
          </h1>
          <ul class="c-archive__list">
            ...
            <?php foreach ($group_items as $group_item): ?>
              ...
              <li class="c-archive__item">
                <div class="c-archive__datetime">
                  <?php echo $group_item['month'] ?>
                  <?php echo $group_item['day'] ?>.
                </div>
                ...
                <div class="c-archive__location">
                  <?php echo $group_item['location'] ?>
                </div>
              </li>
